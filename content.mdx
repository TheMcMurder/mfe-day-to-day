...
<div
  ...
  style={{
    backgroundImage: `url('https://graphicdesignfall16.files.wordpress.com/2016/10/adobe-company-logo.jpg?w=800')`,
    backgroundSize: `400px 400px`,
    backgroundRepeat: 'repeat',
    textShadow: 'black 1px 0 20px',
  }}
>
  <h2 className='text-white'>What is taking so long?</h2>
</div>
...
<div
  className="w-screen h-screen bg-center bg-cover flex items-center flex-col justify-center text-white"
  style={{
    backgroundImage: `url('https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.impawards.com%2F1983%2Fposters%2Freturn_of_the_jedi_ver2.jpg&f=1&nofb=1')`,
    backgroundSize: `270px 400px`,
    backgroundRepeat: 'repeat',
    textShadow: 'black 1px 0 20px',
  }}
>
  ...
  >
    <h2>Migration - Return of the Jedi</h2>
    <ul>
      <li>
...
<div
  className="w-screen h-screen bg-center bg-cover flex items-center flex-col justify-center text-white"
  style={{
    backgroundImage: `url('https://image.tmdb.org/t/p/original/s12hAKDCui6S8GIyRIaz6oKe5OW.jpg')`,
    backgroundSize: `270px 400px`,
    backgroundRepeat: 'repeat',
    textShadow: 'black 1px 0 20px',
  }}
>
  ...
  >
    ...
    <ul>
      ...
      <li>
        <Appear>
          We're working on improvements to the current experience
        </Appear>
      </li>
      <li>
        <Appear>
...
- <Appear>Import maps are a browser specification that is actively being implemented</Appear>
- <Appear>SystemJS provides polyfills for browser specs: import-maps, module loading, and additional related specs.</Appear>
- <Appear>SystemJS also provides a module registery API. This functionality is extremely useful but not part of any browser specifications.</Appear>
...
>
  <h1 className='text-center text-4xl px-4 text-white'>Why Star Wars is the best franchise of all time</h1>
</div>
...
Slides powered by [minideck](https://github.com/filoxo/minideck)
